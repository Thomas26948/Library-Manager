  ...
  <main>
    <section class="content">
      ...
      <h5>Suppression du livre n°${livre.getId()}</h5> <!-- TODO : afficher l'id du livre au lieu de 42 -->
        <div class="row">
          <p>Êtes-vous sûr de vouloir supprimer le livre ${livre.getTitre()} de ${livre.getAuteur()} (code ISBN : ${livre.getId()}) ?</p> <!-- TODO : compléter les trois informations ci-contre -->
	      <form action="/LibraryManager/livre_delete" method="post" class="col s12">
	        ...
	        <div class="row center">
	          ...
	          <a class="btn waves-effect waves-light orange" href="/LibraryManager/livre_details?id=${livre.getId()}">Annuler</a> <!-- TODO : remplacer idDuLivre par l'id du livre -->
	        </div>
	      </form>
	    </div>	    
      </div>
