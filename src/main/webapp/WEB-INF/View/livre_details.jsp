  ...
  <main>
    <section class="content">
      ...
      <h5>Détails du livre n°${livre.id}</h5>
        <div class="row">
	      <form action="/LibraryManager/livre_details?id=${livre.getId()}" method="post" class="col s12"> <!-- TODO : remplacer idDuLivre par l'id du livre -->
	        <div class="row">
	        ...
	        <table class="striped">
              ...
              <tbody id="results">
               ...
               <c:forEach items="${emprunts}" var = "emprunt">
                <tr>
                    <td> ${emprunt.getIdMembre().getMembrePrenom()} ${emprunt.getIdMembre().getMembreNom()} </td>
