          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><%if (request.getAttribute("nlivre") != null) {
                out.println("<p>" + request.getAttribute("nlivre") + "</p>");}%><!-- TODO : afficher le nombre de livres à la place de 27 -->
              <p>Livres</p>
            </div>
            <div class="icon">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><% if (request.getAttribute("nemprunt") != null) {
                out.println("<p>" + request.getAttribute("nemprunt") + "</p>");}%></h3> <!-- TODO : afficher le nombre d'emprunts à la place de 1515 -->
              <p>Emprunts</p>
            </div>
            <div class="icon">
        ...
        <div class="container">
	        <div class="col s12">
	          ...
	          <table class="striped">
                ...
                <tr>
                    <td>${emprunt.getIdLivre().getTitre()},<em>${emprunt.getIdLivre().getAuteur()}</em></td>
                    <td>${emprunt.getIdMembre().getNom()} ${emprunt.getIdMembre().getPrenom()}</td>
