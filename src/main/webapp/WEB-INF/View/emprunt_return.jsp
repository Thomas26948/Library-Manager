	        ...
	        <div class="row">
	          <div class="input-field col s12">
                ...
                <c:forEach items="${emprunts}" var = "emprunt">
                  ...
                  <c:if test="${ idEmprunt == emprunt.getId()}">
                   <option selected value="${emprunt.getId()}">"${emprunt.getIdLivre().getTitre()}" emprunté par ${emprunt.getIdMembre().getPrenom()} ${emprunt.getIdMembre().getNom()} </option>
                  </c:if>    
                
                   <option value="${emprunt.getId()}">"${emprunt.getIdLivre().getTitre()}" emprunté par ${emprunt.getIdMembre().getPrenom()} ${emprunt.getIdMembre().getNom()} </option>
